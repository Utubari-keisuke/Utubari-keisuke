...
神奈川県をメインに、天体物理シミュレーションやAIを活用したアプリケーションの開発を行っています。  
これまでに**国立天文台**や**JAXA**のインターンや、叔父と父の推薦で中国やカナダに渡り同じ志をもつ同僚らと共に高性能AIを作るプロジェクト「STAR ANCHER」を率いてきました。  
...
* **One-liner:** 「NASAに就職した久我慧祐と亡き大親友を超えるために勉強中！」
